...
const MESSAGES: Record<"zh" | "en", MessageCatalog> = {
  zh: {
    ...
    metricCurrentRoomCode: "当前房间",
    sectionAnnouncements: "公告",
    sectionRoom: "房间",
    actionCopy: "复制",
    actionCopyInvite: "复制邀请",
    actionLeave: "退出",
    actionLeaveRoom: "退出房间",
    actionCreate: "创建",
    actionCreateRoom: "创建房间",
    roomCodePlaceholder: "请粘贴房间码",
    roomEntryHelp: "创建房间，或输入朋友发来的房间码。",
    actionJoin: "加入",
    easterEggTitle: "隐藏频道已点亮",
    easterEggBody: "fupengzi 频道进入同步星轨，祝你们开播顺风。",
    sectionSharedVideo: "共享视频",
    stateNoSharedVideo: "暂无共享视频",
    stateNotJoined: "未加入",
    stateNotInRoom: "未加入房间",
    stateNotSynced: "未同步",
    actionOpenSharedVideoHint: "点击可打开共享视频",
    actionOpenSharedVideo: "打开共享视频",
    ownerSharedBy: "由 {owner} 共享",
    sharedVideoIdleHint: "加入房间后显示共享视频标题、来源和分享人。",
    actionShareCurrentVideo: "同步当前视频",
    sectionRoomMembers: "在线成员",
    sectionAdvancedInfo: "高级设置与调试",
    actionExpand: "展开",
    actionExpanded: "已展开",
    ...
    retryProgressSuffix: "重试{progress}",
    retryProgressValue: "（{attempt}/{max}）",
    clockStatus: "偏移 {offset}ms / RTT {rtt}ms",
    stateNoMembers: "暂无成员",
    memberSelf: "我（{name}）",
    memberSelfFallback: "我",
    confirmCreateRoomTitle: "创建房间并同步？",
    confirmReplaceVideoTitle: "替换共享视频？",
    confirmCreateAndShare: "创建并同步",
    confirmReplaceVideo: "确认替换",
    confirmDialogCancel: "取消",
    confirmCreateRoomBeforeShare: "当前未加入房间。创建房间后会同步当前视频。",
  ...
  en: {
    ...
    roomEntryHelp: "Create a room, or paste the room code from a friend.",
    actionJoin: "Join",
    easterEggTitle: "Secret channel unlocked",
    easterEggBody: "The fupengzi channel is tuned for a smooth watch party.",
    sectionSharedVideo: "Shared video",
    stateNoSharedVideo: "No shared video yet",
    stateNotJoined: "Not joined",
    stateNotInRoom: "Not in room",
    ...
    sharedVideoIdleHint:
      "Join a room to show the shared title, source, and sharer.",
    actionShareCurrentVideo: "Sync current video",
    sectionRoomMembers: "Online members",
    sectionAdvancedInfo: "Advanced settings",
    actionExpand: "Expand",
    actionExpanded: "Expanded",
    metricServerUrl: "Server URL",
    actionSave: "Save",
    actionCopyLogs: "Copy logs",
    ...
    membersCountSingular: "{count} member",
    ...
    retryProgressSuffix: " Retry {progress}",
    retryProgressValue: "({attempt}/{max})",
    clockStatus: "Offset {offset}ms / RTT {rtt}ms",
    stateNoMembers: "No members yet",
    memberSelf: "Me ({name})",
    memberSelfFallback: "Me",
    confirmCreateRoomTitle: "Create room and sync?",
    confirmReplaceVideoTitle: "Replace shared video?",
    confirmCreateAndShare: "Create and sync",
    confirmReplaceVideo: "Replace video",
    confirmDialogCancel: "Cancel",
    confirmCreateRoomBeforeShare:
      "You're not in a room yet. Create a room to sync the current video.",
    confirmReplaceSharedVideo:
